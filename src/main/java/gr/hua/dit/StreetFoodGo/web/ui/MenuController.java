...
public class MenuController {
    ...
    public MenuController(MenuService menuService ,  PersonRepository personRepository,  CurrentUserProvider currentUserProvider , MenuMapper menuMapper, OrderService orderService) {
    ...
    public String addItemFromMenu(
        ...
        orderService.addItemToOpenOrder(
                user.id(),
                restaurantId,
                menuItemId
        );
